...
path_w='/Users/alexander/Documents/projects/NetKet/Hubbard/measurement'
path_d='/Users/alexander/Documents/projects/NetKet/Hubbard/data'
...
file_path = os.path.join(path_w, "state_after_VMC.mpack")
with open(
    file_path,
    "rb",
) as file:
...
if 'E' in order:
    E = vstate.expect(H)
    print(E)
    np.savetxt('{path:s}/energy_U={U:.3f}_L={L:d}_Ne={Ne:d}_iter={N_opt:d}.txt'.format(path=path_w,U=U,L=L,N_opt=N_opt,Ne=Ne),[E.mean.real])
